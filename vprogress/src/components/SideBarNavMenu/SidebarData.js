...
const SidebarDataAdmin = [
  { title: 'Inicio', path: '/', icon: <AiIcons.AiFillHome />, cName: 'nav-text', child: [] },
  { title: 'Productos', path: '/Productos', icon: <FaIcons.FaCartPlus />, cName: 'nav-text', child: [
    { title: 'Listar', path: '/listproducts', icon: <FaIcons.FaCartPlus />, cName: 'nav-text'},
    { title: 'Nuevo', path: '/agregar', icon: <FaIcons.FaCartPlus />, cName: 'nav-text'},
    { title: 'Administrar', path: '/listproducts', icon: <FaIcons.FaCartPlus />, cName: 'nav-text'},
  ] },
