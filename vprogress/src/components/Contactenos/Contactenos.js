      ...
      <section id="general_section">
        <div className="nosotros">
          ...
          <p className="texto_nosotros">
            ...
            varios años de experiencia en el mercado y miles de clientes
            felices.
          </p>
          <p className="texto_nosotros">
            ...
            nuestros clientes, desde lo mas antiguo pasando por figuras de
            suprema coleccion, como ediciones especiales de comics hasta los
            ultimos articulos de coleccion que quieras tener, nuestra oferta no
            termina alli, tenemos toda clase de variedad de productos,
            preguntanos..
          </p>
          <p className="texto_nosotros">
            Hemos particpado en diferentes ferias como, el Campus Party, el
            AnimeCoon, el comic con, la Poli week, entre otros, varios
            estudiantes de la Universidad Politecnico Grancolombiano, pueden dar
            fe de la calidad y seriedad de nuestros productos y transacciones.
          </p>
        </div>
